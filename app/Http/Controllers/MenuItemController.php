...
class MenuItemController extends BaseController
{
    ...
    // If NOT super admin → restrict to logged-in user's supplier
    if (!auth()->user()->hasRole('super_admin')) {
        ...
        if ($supplier) {
            ...
            // Optional: return empty result if no supplier found
...
public function create()
{
    ...
    // Categories are global — no supplier filter needed
    $categories = MenuCategory::orderBy('category_name')->get();

    return view('in.menu.menu_items.create', compact('suppliers', 'categories'));
}
